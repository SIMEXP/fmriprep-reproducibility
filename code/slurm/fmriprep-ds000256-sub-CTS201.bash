...
#SBATCH --output=/scratch/%u/fmriprep_ds000256-sub-CTS201_%A_%a.out
#SBATCH --error=/scratch/%u/fmriprep_ds000256-sub-CTS201_%A_%a.err
...
singularity run --cleanenv -B $SLURM_TMPDIR/fmriprep-lts:/WORK -B $HOME/.cache/templateflow:/templateflow -B /etc/pki:/etc/pki/ $SLURM_TMPDIR/fmriprep-lts/envs/fmriprep-20.2.1lts.sif -w /WORK/fmriprep_work --participant-label CTS201 --output-spaces MNI152NLin2009cAsym MNI152NLin6Asym --notrack --write-graph --omp-nthreads 8 --nprocs 16 --mem_mb 65536 --resource-monitor /WORK/inputs/openneuro/ds000256 /WORK/inputs/openneuro/ds000256/derivatives/fmriprep participant 
fmriprep_exitcode=$?
