...
def compute_task_statistics(
        input_dir, dataset, participant, independent_anat_func=False, exp_multithread=False, exp_multiprocess=False, n_samples=5, sampling="ieee", output_template="MNI152NLin2009cAsym"):
